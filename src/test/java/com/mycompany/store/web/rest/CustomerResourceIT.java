...
import com.mycompany.store.OnlineApp;
 ...
 */
@SpringBootTest(classes = OnlineApp.class)
public class CustomerResourceIT {
    ...
    private static final String DEFAULT_EMAIL = "x,@DE.%";
    private static final String UPDATED_EMAIL = "W)@mD.IW";
