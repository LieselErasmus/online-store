...
describe('Shipment e2e test', () => {
  ...
  it('should load Shipments', async () => {
    ...
    expect(await shipmentComponentsPage.getTitle()).to.eq('onlineApp.shipment.home.title');
  });
  ...
  it('should load create Shipment page', async () => {
    ...
    expect(await shipmentUpdatePage.getPageTitle()).to.eq('onlineApp.shipment.home.createOrEditLabel');
  ...
  it('should delete last Shipment', async () => {
    ...
    expect(await shipmentDeleteDialog.getDialogTitle()).to.eq('onlineApp.shipment.delete.question');
