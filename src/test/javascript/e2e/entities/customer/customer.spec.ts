...
describe('Customer e2e test', () => {
  ...
  it('should load Customers', async () => {
    ...
    expect(await customerComponentsPage.getTitle()).to.eq('onlineApp.customer.home.title');
  });
  ...
  it('should load create Customer page', async () => {
    ...
    expect(await customerUpdatePage.getPageTitle()).to.eq('onlineApp.customer.home.createOrEditLabel');
  ...
  it('should delete last Customer', async () => {
    ...
    expect(await customerDeleteDialog.getDialogTitle()).to.eq('onlineApp.customer.delete.question');
